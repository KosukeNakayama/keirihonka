...
@WebServlet(urlPatterns={"/Class/ClsRegExe"})
public class ClsRegExe extends HttpServlet {

	public void doGet (
			HttpServletRequest request, HttpServletResponse response
		) throws ServletException, IOException {

			System.out.println("ClsRegExe");
			//ログインチェック
			...
			try {
				...
				clsDao.regCls(stuIds,schoolYear,grade,classNo,startDate);

				//レスポンス値をセット 6
				request.setAttribute("message","クラスの登録が完了しました");
